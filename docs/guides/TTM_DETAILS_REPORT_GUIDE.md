...
- **DevLT (Development Lead Time)** - время от первого валидного "МП / В работе" до последнего валидного "МП / Внешний тест" (календарное время, без исключения пауз)
...
- Показывает время разработки от начала работы до начала внешнего тестирования
