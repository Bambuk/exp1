...
class GoogleSheetsConfig:
    ...
    CREDENTIALS_PATH: str = os.getenv("GOOGLE_SHEETS_CREDENTIALS_PATH", "sheet-api-key.json")
    DOCUMENT_ID: str = os.getenv("GOOGLE_SHEETS_DOCUMENT_ID", "1lmN2L9UORwOPycpRZNX_TKl93S8WSh71YmKuyYDrL7g")
    ...
    MAX_FILE_SIZE: int = int(os.getenv("GOOGLE_SHEETS_MAX_FILE_SIZE", str(50 * 1024 * 1024)))  # 50MB
    SUPPORTED_ENCODINGS: list = [
        'utf-8', 'utf-8-sig', 'windows-1251', 'cp1251', 'iso-8859-1'
    ]
