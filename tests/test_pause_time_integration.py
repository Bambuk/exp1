    ...
    def setup_method(self):
        ...
        self.mock_histories = {
            ...
            2: [
                StatusHistoryEntry("New", "New", datetime(2024, 1, 1), None),
                StatusHistoryEntry(
                    "In Progress", "In Progress", datetime(2024, 1, 2), None
                ),
                StatusHistoryEntry(
                    "МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 4), None
                ),
    ...
    def test_full_report_generation_with_pause_time(self, test_reports_dir):
        ...
        with GenerateTimeToMarketReportCommand(
            ...
            cmd.data_service.get_task_history.side_effect = (
                lambda task_id: self.mock_histories.get(task_id, [])
            )
            ...
            assert (
                author1_metrics.tail_metrics.count == 1
            )  # Has MP/External Test status in mock history
