...
class TestTelegramSheetsIntegration:
    ...
    def mock_services(self, temp_dir):
        ...
        with patch(
            "radiator.telegram_bot.bot.TelegramBotConfig"
        ) as mock_telegram_config, patch(
            "radiator.services.csv_file_monitor.GoogleSheetsConfig"
        ) as mock_sheets_config, patch(
            ...
            sheets_service = GoogleSheetsService(
                credentials_path="test_credentials.json", document_id="test_document_id"
            )
    ...
    def test_state_persistence(self, mock_services, temp_dir):
        ...
        assert new_monitor.file_timestamps == {
            "file1.csv": 1234567890,
            "file2.csv": 1234567891,
        }
