...
class TestTaskDetailsCSV:
    ...
    def test_generate_task_details_csv_multiple_quarters(self):
        ...
        quarter_report2 = QuarterReport(
            ...
            groups={
                "Author1": GroupMetrics(
                    group_name="Author1",
                    ttd_metrics=TimeMetrics(times=[], mean=None, p85=None, count=0, pause_times=[], pause_mean=None, pause_p85=None),
                    ttm_metrics=TimeMetrics(times=[6, 8], mean=7.0, p85=8.0, count=2, pause_times=[0, 0], pause_mean=0.0, pause_p85=0.0),
                    tail_metrics=TimeMetrics(times=[1, 2], mean=1.5, p85=2.0, count=2, pause_times=[0, 0], pause_mean=0.0, pause_p85=0.0),
                    total_tasks=2
                )
            }
        )
    ...
    def test_generate_task_details_csv_error_handling(self):
        ...
        self.command.data_service.get_tasks_for_period.side_effect = Exception("Database error")
