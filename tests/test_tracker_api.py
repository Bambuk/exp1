...
class TestTrackerAPIServiceIntegration:
    ...
    def test_make_request_with_real_http_call(self, service):
        ...
        with patch('radiator.services.tracker_service.requests.request', return_value=mock_response) as mock_request:
    ...
    def test_error_handling_integration(self, service):
        ...
        mock_error_response.raise_for_status.side_effect = requests.exceptions.HTTPError("400 Client Error")
        
        with patch('radiator.services.tracker_service.requests.request', return_value=mock_error_response):
    ...
    def test_parallel_processing_integration(self, service):
        ...
        with patch.object(service, 'get_task', return_value=mock_task_data) as mock_get_task:
