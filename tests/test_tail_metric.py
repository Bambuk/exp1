...
class TestTailMetric:
    ...
    def test_calculate_tail_metric_success(self):
        ...
        history = [
            ...
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 5), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 7), None),  # Exit from MP/External Test
    ...
    def test_calculate_tail_metric_multiple_mp_external_test(self):
        ...
        history = [
            StatusHistoryEntry("New", "New", datetime(2024, 1, 1), None),
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 3), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 5), None),  # First exit
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 7), None),
            StatusHistoryEntry("Done", "Done", datetime(2024, 1, 10), None),  # Second exit (last one)
        ]
        
        result = self.service.calculate_tail_metric(history, ["Done"])
        assert result == 3  # 10 days - 7 days (last exit from MP/External Test) = 3 days
    ...
    def test_calculate_tail_metric_with_pause_time(self):
        ...
        history = [
            StatusHistoryEntry("New", "New", datetime(2024, 1, 1), None),
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 3), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 5), None),  # Exit from MP/External Test
            StatusHistoryEntry("Приостановлено", "Приостановлено", datetime(2024, 1, 7), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 9), None),  # Resume
    ...
    def test_calculate_tail_metric_no_done_status(self):
        ...
        history = [
            ...
            StatusHistoryEntry("In Progress", "In Progress", datetime(2024, 1, 7), None),
        ]
    ...
    def test_calculate_tail_metric_multiple_done_statuses(self):
        ...
        history = [
            ...
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 3), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 5), None),  # Exit from MP/External Test
            StatusHistoryEntry("Выполнено с ИТ", "Выполнено с ИТ", datetime(2024, 1, 8), None),  # First done status
            StatusHistoryEntry("Done", "Done", datetime(2024, 1, 10), None),
        ]
    ...
    def test_calculate_tail_metric_complex_pause_scenario(self):
        ...
        history = [
            ...
            StatusHistoryEntry("Приостановлено", "Приостановлено", datetime(2024, 1, 7), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 9), None),  # Resume
            StatusHistoryEntry("Приостановлено", "Приостановлено", datetime(2024, 1, 11), None),
...
class TestTailMetricIntegration:
    ...
    def test_tail_metric_with_ttd_and_ttm(self):
        ...
        history = [
            StatusHistoryEntry("New", "New", datetime(2024, 1, 1), None),
            StatusHistoryEntry("In Progress", "In Progress", datetime(2024, 1, 3), None),  # First change
            StatusHistoryEntry("Готова к разработке", "Готова к разработке", datetime(2024, 1, 5), None),  # TTD target
            StatusHistoryEntry("МП / Внешний тест", "МП / Внешний тест", datetime(2024, 1, 7), None),
            StatusHistoryEntry("Review", "Review", datetime(2024, 1, 9), None),  # Exit from MP/External Test
            StatusHistoryEntry("Done", "Done", datetime(2024, 1, 12), None),  # TTM target
        ]
