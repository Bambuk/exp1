...
class TestGoogleSheetsService:
    ...
    def mock_service(self):
        ...
        with patch('radiator.services.google_sheets_service.service_account.Credentials.from_service_account_file'), \
    ...
    def test_sanitize_sheet_name_invalid_chars(self, mock_service):
        ...
        assert result == "chars"  # After removing invalid chars and multiple underscores
    ...
    def test_test_connection_failure(self, mock_service):
        ...
        mock_service.service.spreadsheets().get().execute.side_effect = Exception("Connection failed")
