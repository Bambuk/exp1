...
def upgrade() -> None:
    ...
    op.create_index('idx_tracker_tasks_tracker_id', 'tracker_tasks', ['tracker_id'], unique=True)
    op.create_index('idx_tracker_tasks_last_sync', 'tracker_tasks', ['last_sync_at'])
    
    # Create tracker_task_history table
    op.create_table('tracker_task_history',
    ...
    op.create_index('idx_tracker_history_task_status', 'tracker_task_history', ['task_id', 'status'])
    op.create_index('idx_tracker_history_dates', 'tracker_task_history', ['start_date', 'end_date'])
    
    # Create tracker_sync_logs table
    op.create_table('tracker_sync_logs',
        sa.Column('id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_index('idx_tracker_sync_logs_started', 'tracker_sync_logs', ['sync_started_at'])
